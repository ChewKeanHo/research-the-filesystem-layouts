# `[FRAMEWORKNAME].framework/Versions/[VERSION]/Resources/[LANG].lproj`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This directory houses a specific version of framework's single language-specific
resources files used by its single main entry point executable. This is the
usual workspaces a framework developer works in where it uses and summon the
required assets from this directory.
