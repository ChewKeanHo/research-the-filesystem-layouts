# `[FRAMEWORKNAME].framework/Versions/[VERSION]/Helpers`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This directory houses a framework's help resources (not help executable) data
files. For executables, place them inside `MacOS` directory instead.
