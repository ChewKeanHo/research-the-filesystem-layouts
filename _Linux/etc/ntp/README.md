...
This base directory houses all operating system (OS)'s Network Time Protocol
(NTP)'s stored times files. This means it can operate in `Single-User` mode in
...
Refer `ntpd` manual for specifications.
