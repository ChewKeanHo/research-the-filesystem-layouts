#  Consolidated Linux-based OSes' Filesystem Layout

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This is the consolidated Linux-based operating system (OS)es Filesystem Layout
based on various Filesystem Hierarchy Standard (FHS) sources notable:
