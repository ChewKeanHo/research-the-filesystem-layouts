...
CPU architecture specific library files (e.g compiled linkable object files) of
an operating system (OS) to function properly and minimally without any mounting
...
symbolic linked from `/usr/lib[ARCH]`, you **MUST** place the content in
`/usr/lib[ARCH]` instead.
