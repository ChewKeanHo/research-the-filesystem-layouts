...
distributor supplied, non-critical, system XML data files of an OS to function
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/xml` or
`${HOME}/[USERNAME]/.local/share/xml` instead.
