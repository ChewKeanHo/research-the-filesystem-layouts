...
distributor supplied, non-critical, printer definition files of an OS to
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/ppd`
or `${HOME}/[USERNAME]/.local/share/ppd` instead.
