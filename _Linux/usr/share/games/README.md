...
OS distributor supplied, non-critical, ACIII text files used by BSD heritage
games to extend the OS' functionalities from *Critical & Minimal* stage to
...
will break the OS in any way. Use `/usr/local/share/games` or
`${HOME}/[USERNAME]/.local/share/games` instead.
