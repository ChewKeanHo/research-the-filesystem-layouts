...
distributor supplied, non-critical, color data files of an OS to function
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/color`
or `${HOME}/[USERNAME]/.local/share/color` instead.
