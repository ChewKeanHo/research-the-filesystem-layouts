...
OS distributor supplied, non-critical, color data files to extend the OS'
...
will break the OS in any way. Use `/usr/local/share/color` or
`${HOME}/[USERNAME]/.local/share/color` instead.
