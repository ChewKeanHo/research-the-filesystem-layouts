...
distributor supplied, non-critical, SGML usable resource files of an OS to
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/sgml`
or `${HOME}/[USERNAME]/.local/share/sgml` instead.
