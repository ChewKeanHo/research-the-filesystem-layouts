...
OS distributor supplied, non-critical, words list files to extend the OS'
...
will break the OS in any way. Use `/usr/local/share/dict` or
`${HOME}/[USERNAME]/.local/share/dict` instead.
