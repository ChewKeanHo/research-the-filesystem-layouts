...
OS distributor supplied, non-critical, troff macros not distributed with groff
data files to extend the OS' functionalities from *Critical & Minimal* stage to
