...
distributor supplied, non-critical, groff usable undistributed troff macros
data files of an OS to function properly. This means it can operate in
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/tmac` or
`${HOME}/[USERNAME]/.local/share/tmac` instead.
