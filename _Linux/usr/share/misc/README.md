...
distributor supplied, non-critical, miscellaneous system data files of an OS to
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/misc`
or `${HOME}/[USERNAME]/.local/share/misc` instead.
