...
distributor supplied, non-critical, GNU system info files of an OS to function
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/info` or
`${HOME}/[USERNAME]/.local/share/info` instead.
