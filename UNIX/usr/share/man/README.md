...
distributor supplied, non-critical, manual documentation files of an OS to
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/man`
or `${HOME}/[USERNAME]/.local/share/man` instead.
