# `[APPNAME].app/[APPNAME] Watch App/PlugIns`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This directory houses an app's many dependencies specifically Apple complied
plugin bundles. A single plugin can have various resource files such as but not
...
Refer to [Apple iOS Plugin Bundle Filesystem](/_iOS.bundle).
