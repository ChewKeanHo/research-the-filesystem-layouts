# `/Library/Frameworks/[PLUGINNAME].bundle/Contents/Helpers`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This directory houses a plugin bundle's help resources (not help executable)
data files. For executables, place them inside `MacOS` directory instead.
...
```
[PLUGINNAME].bundle/Contents/Helpers/
  trademark/
    product/
      README.txt
      HOW-TO.txt
