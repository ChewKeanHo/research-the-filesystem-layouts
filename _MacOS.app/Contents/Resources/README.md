...
This directory houses an app's resources files used by the app's single main
entry point executable. This is the usual workspaces an app developer works in
where it uses and summon the required assets from this directory.
