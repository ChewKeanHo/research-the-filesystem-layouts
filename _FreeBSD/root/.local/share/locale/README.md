# `/root/.local/share/locale`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This is the base directory for housing the `root` account, user-specific, user
supplied, non-critical, localization data files of an OS to function properly.
...
```
/root/.local/share/locale/[LAND_ID]/
  trademark/
    product/
      encryption.mo
      sign.mo
