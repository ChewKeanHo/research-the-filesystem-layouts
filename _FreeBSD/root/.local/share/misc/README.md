# `/root/.local/share/misc`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This is the base directory for housing `root` account's user-specific, user
supplied, non-critical, miscellaneous system data files of an OS to function
