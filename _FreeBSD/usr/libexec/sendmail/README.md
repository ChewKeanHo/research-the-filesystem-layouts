...
distributor supplied, non-critical, non-commandable `sendmail` and `mailwrapper`
programs and applications of an OS to function properly. This means it can
...
Refer `sendmail` and `mailwrapper` manuals for specifications.
