...
OS distributor supplied, non-critical, non-user dwatch system profiling programs
and applications to extend the OS' functionalities from *Critical & Minimal*
...
Refer to `dwatch(1)` for specifications.
