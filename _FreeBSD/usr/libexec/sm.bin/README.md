...
OS distributor supplied, non-critical, non-user, system-only, `sendmail`'s and
`mailwrapper`'s restricted shell scripts, programs, and applications
(e.g. daemon server) to extend the OS' functionalities from *Critical & Minimal*
