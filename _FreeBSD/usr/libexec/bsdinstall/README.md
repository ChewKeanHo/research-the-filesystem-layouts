...
distributor supplied, non-critical, non-commandable FreeBSD's ncurses programs
and applications of an OS to function properly. This means it can operate in
...
Refer `bsdinstall(8)` manual for specifications.
