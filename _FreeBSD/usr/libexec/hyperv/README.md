...
OS distributor supplied, non-critical, non-user, system-only, Hyper-V hypervisor
communication programs and applications to extend the OS' functionalities from
