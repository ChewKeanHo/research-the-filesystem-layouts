...
distributor supplied, non-critical, `vt` system console usable resource files of
...
Refer `vt(4)` manual for specifications.

This directory structure is specific by design containing on specific resources
directories.

Here are the known directories:
