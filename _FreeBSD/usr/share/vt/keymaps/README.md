...
distributor supplied, non-critical, `vt` system console usable keyboard mapping
...
Refer `vt(4)`, `kbdcontrol(1)`, and `kbdmap(1)` manuals for specifications.
...
```
/usr/share/vt/keymaps/
  trademark-product-name1.kbd
  trademark-product-name2.kbd
  ...
