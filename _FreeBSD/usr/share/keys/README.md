...
distributor supplied, non-critical, known trusted and revoked keys files of an
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/keys` or
`${HOME}/[USERNAME]/.local/share/keys` instead.
