...
distributor supplied, non-critical, `termcap` terminal usable tap description
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/tabset`
or `${HOME}/[USERNAME]/.local/share/tabset` instead.
...
Refer `termcap(5)` manual for specifications.
