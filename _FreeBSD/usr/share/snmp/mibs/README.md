...
distributor supplied, non-critical, SNMP daemon usable
Management Information Base (MIB) resource files of an OS to function properly.
...
`/usr/local/share/snmp/mibs` or `${HOME}/[USERNAME]/.local/share/snmp/mibs`
instead.
