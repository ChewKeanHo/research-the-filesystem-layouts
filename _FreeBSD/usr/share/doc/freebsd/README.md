...
distributor supplied, non-critical, FreeBSD document (e.g. PDF, HTML, text)
file of an OS to function properly. This means it can operate in `Multi-User`
...
`/usr/local/share/doc/freebsd` or `${HOME}/[USERNAME]/.local/share/doc/freebsd`
instead.
