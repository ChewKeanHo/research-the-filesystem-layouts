...
distributor supplied, non-critical, `syscons` system terminal usable font files
...
`/usr/local/share/syscons/fonts` or
`${HOME}/[USERNAME]/.local/share/syscons/fonts` instead.
...
```
/usr/share/syscons/fonts/
  trademark-product-8x8.fnt
  trademark-product-8x16.fnt
  ...
