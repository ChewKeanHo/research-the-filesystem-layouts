...
distributor supplied, non-critical, `syscons` system terminal usable keyboard
mapping resource files of an OS to function properly. This means it can operate
...
`/usr/local/share/syscons/keymaps` or
`${HOME}/[USERNAME]/.local/share/syscons/keymaps` instead.
...
```
/usr/share/syscons/keymaps/
  trademark-product-8x8.kbd
  trademark-product-8x16.kbd
  ...
