...
distributor supplied, non-critical, `syscons` system terminal usable screen
...
`/usr/local/share/scrnmaps` or `${HOME}/[USERNAME]/.local/share/scrnmaps`
instead.
...
```
/usr/share/syscons/scrnmaps/
  trademark-product-8x8.scm
  trademark-product-8x16.scm
  ...
