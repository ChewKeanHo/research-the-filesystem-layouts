...
distributor supplied, non-critical, `syscons` system terminal usable resource
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/syscons`
or `${HOME}/[USERNAME]/.local/share/syscons` instead.
...
Refer `syscons(4)` manual for specifications and file directory structures.
