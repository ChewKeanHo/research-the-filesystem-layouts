...
distributor supplied, non-critical OpenSSL dynamically loadable module files of
...
will break the OS updates or upgardes in any way. In the case of `/lib` being
...
Refer `openssl` manual for specifications.
