...
distributor supplied, non-critical FreeBSD Lua shared library files (e.g
...
will break the OS updates or upgardes in any way. Use `/usr/local/lib/flua` or
`${HOME}/[USERNAME]/.local/lib/flua` instead. In the case of `/lib` being
