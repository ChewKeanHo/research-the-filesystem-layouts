...
OS distributor supplied, non-critical, standalone debug data for kernel and base
system library (e.g. C object artifact files) and executable files to extend the
