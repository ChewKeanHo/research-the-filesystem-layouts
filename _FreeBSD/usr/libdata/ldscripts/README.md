...
distributor supplied, non-critical LLVM project's ELF linker data files of an OS
...
Refer to `ld` manual for specifications.

In any case, it is a practice to house the files using `trademark` and `product`
