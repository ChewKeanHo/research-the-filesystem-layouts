...
distributor supplied, non-critical, cpu architecture specific, FreeBSD built
target tree filesystem artifact of an OS to function properly. This means it can
...
Refer `build(7)` manual for specifications.
