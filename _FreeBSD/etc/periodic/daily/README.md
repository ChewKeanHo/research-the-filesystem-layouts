...
This base directory houses all operating system (OS)'s cron daily scheduler's
...
Note that the configuration in this `daily` directory is similar to:
...
`/usr/local/etc/periodic/daily` instead. Therefore, generally, you
