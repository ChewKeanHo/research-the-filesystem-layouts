...
This base directory houses all operating system (OS)'s cron monthly scheduler's
...
Note that the configuration in this `monthly` directory is similar to:
...
`/usr/local/etc/periodic/monthly` instead. Therefore, generally, you
