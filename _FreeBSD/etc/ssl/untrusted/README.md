...
cert in `/usr/local/share/certs/untrusted` and use `certctl(8)` to update the
OS' SSL certs archives.
...
Refer `certctl(8)` manual for the specifications and file directory structures.
