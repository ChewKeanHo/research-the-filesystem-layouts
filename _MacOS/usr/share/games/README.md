...
distributor supplied, non-critical, game data files of an OS to function
...
will break the OS updates or upgardes in any way. Use `/usr/local/share/games`
or `${HOME}/[USERNAME]/.local/share/games` instead.
