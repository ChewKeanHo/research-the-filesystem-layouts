# `[DRIVE]/Users/[USERNAME]/.local/src`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This is the base directory for a single user's housing user-specific, user
supplied, non-critical source files (e.g. C source files) of an operating
