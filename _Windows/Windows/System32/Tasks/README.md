# `[DRIVE]\Windows\System32\Tasks`

[![banner](/.internals/trademarks/banner_1200x100.svg)](#)

This is the base directory for housing critical and distributor supplied
Task Scheduler's schedule and task files to enable the operating system (OS)
...
Microsoft Windows specifically designed its Task Scheduler's configuration
files. Refer to OS distributor's documentations for specifications.
