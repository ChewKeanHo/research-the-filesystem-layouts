...
Windows Recovery Environment (WinRE) "rescue" image data files to enable the
operating system (OS) function properly and minimally without any mounting
...
Microsoft Windows specifically designed its Windows Recovery Environment (WinRE)
"rescue" files (e.g. `winre.wim`). Refer to OS distributor's documentations for
specifications.
