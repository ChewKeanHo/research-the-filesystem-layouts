...
OS distributor supplied, non-critical, temporary data files to function properly
and minimally without any mounting (e.g. `[DRIVE]\Program Files` is not ready or
absent).
