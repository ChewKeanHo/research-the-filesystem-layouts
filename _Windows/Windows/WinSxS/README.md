...
OS distributor supplied, non-critical, updatable, rollback-capable, OS
self-repairable, "Windows Side-by-Side" component store's system, components,
service packs data files to function properly and minimally without any mounting
