...
non-critical, non-user programs and applications (e.g. daemon server) for
extending the operating system (OS)'s functionalities from *Complete* stage to
*Personalized* stage.

Programs and applications **MUST** be executed using full filepath instead of
the usual command list.
